...
function KaolinSoccerGameMode:GoalScored( team )
        print('[KaolinSoccer] Goal Scored')
        print(team)
...
function SpawnDummy()
    ...
    local dummyLocation = Entities:FindByName(nil, "dummy_spawn_loc")
    stone_dummy = CreateUnitByName("npc_dummy_unit", dummyLocation:GetAbsOrigin(), true, nil, nil, DOTA_TEAM_GOODGUYS) 
    stone_dummy:FindAbilityByName('kaolin_soccer_stone_caller'):SetLevel(1)
    SpawnStone()
